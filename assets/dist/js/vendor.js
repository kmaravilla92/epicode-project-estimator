...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;/*! jQuery Validation Plugin - v1.19.0 - 11/28/2018
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _scss__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./scss */ "./vendor/scss/index.js");
...
/* harmony import */ var _js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./js */ "./vendor/js/index.js");
// SCSS
 // JS
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _polyfills__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./polyfills */ "./vendor/js/polyfills.js");
...
/* harmony import */ var respimage__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! respimage */ "../node_modules/respimage/respimage.min.js");
/* harmony import */ var respimage__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(respimage__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var _lazysizes_config__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./lazysizes-config */ "./vendor/js/lazysizes-config.js");
...
/* harmony import */ var jquery_validation_dist_jquery_validate_min_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! jquery-validation/dist/jquery.validate.min.js */ "../node_modules/jquery-validation/dist/jquery.validate.min.js");
/* harmony import */ var jquery_validation_dist_jquery_validate_min_js__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(jquery_validation_dist_jquery_validate_min_js__WEBPACK_IMPORTED_MODULE_6__);



 // Lightweight picture and srcset polyfill

 // Config for lazyloader

 // Lazyloader for media



/***/ }),

/***/ "./vendor/js/lazysizes-config.js":
/*!***************************************!*\
  !*** ./vendor/js/lazysizes-config.js ***!
  \***************************************/
...
var init = function init() {
  var lqipBgs = document.querySelectorAll('.js.lqip-background');

  for (var i = 0; i < lqipBgs.length; i++) {
    // Start listening for lazysizes event
    lqipBgs[i].addEventListener('lazybeforeunveil', loadOriginalBg);
  }
};

var loadOriginalBg = function loadOriginalBg(e) {
  var elem = e.target;
  var src = elem.getAttribute('data-background-src');
  var srcset = elem.getAttribute('data-background-srcset');
  var original = new window.Image(); // If there is a srcset specified, calculate src based on width of parentNode

  if (srcset) {
    // Get width of parentNode
    var parWidth = elem.parentNode.offsetWidth;
    var parHeight = elem.parentNode.offsetHeight; // Parse srcset as JSON

    srcset = JSON.parse(srcset); // Sort srcset from small to large size
    ...
    for (var i = 0; i < srcset.length; i++) {
      var _src = srcset[i]; // Start loading src which size is large enough to fill parent width

      if (parWidth <= parseInt(_src.width) && parHeight <= parseInt(_src.height)) {
        original.src = _src.url; // After the first match, stop the loop completely since this src
  ...
  original.addEventListener('load', function () {
    elem.style.backgroundImage = "url('".concat(original.src, "')");
  });
}; // Init
// --------------------------------
